...
CODER1_EXEC = os.environ.get("CODER1_EXEC", "sandboxfusion")
...
def _compute_score(solution_str, ground_truth, extra_info):
    # reward_log = []
...
if __name__ == "__main__":
    pass
    solution = SOLUTION
    code_blocks = CODE_PATTERN.findall(solution)
    res = "\n".join(code_blocks).strip()
    stc()