...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    ...
    # NOTE: added by xize
    if data_source.startswith("creative"):
        from . import creative
        res = creative.compute_score(solution_str, ground_truth, extra_info=extra_info)
    ...
    # NOTE: above is added by Reasoning360
        ...
        from . import math_ours

        res = math_ours.compute_score(solution_str, ground_truth)
