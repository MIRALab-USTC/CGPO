...
DATA_SOURCES_CODEGEN = ['codegen__primeintellect', 'codegen__leetcode2k', 'codegen__livecodebench', 'codegen__taco']
DATA_SOURCES_MATH = ['math__merged_deduped_dapo_or1_dataset', 'math__deepscaler_preview']
DATA_SOURCES_LOGIC = ['logic__ordering_puzzle_dataset', 'logic__graph_logical_dataset', 'logic__zebra_puzzle_dataset']
DATA_SOURCES_SIMULATION = ['simulation__codeio', 'simulation__arcagi1', 'simulation__arcagi2', 'simulation__barc']
DATA_SOURCES_STEM_LLM = ['stem_web']
DATA_SOURCES_TABLE = ['table__hitab', 'table__multihier']
DATA_SOURCES_CREATIVE = ['creative__writing__shareGPT']
...
class RewardModelWorker(Worker):
    def __init__(self, config):
        ...
        self.llm_judgement_path = config.llm_judgement_path
        self.need_verifier = config.need_verifier
    ...
    def compute_rm_score(self, data: DataProto) -> DataProto:
        ...
        for i in range(len(data)):
            ...
            extra_info["llm_judgement_path"] = self.llm_judgement_path
            
            if data_source in DATA_SOURCES_STEM_LLM:
                use_rm.append(i)
                ...
                # STEM 数据的 extra_info 包含 question
        ...
        if self.need_verifier:
            ...
            for i, (ground_truth, solution, verification, valid_response_length) in enumerate(
                ...
                reward_tensor[use_rm[i], valid_response_length - 1] = score
